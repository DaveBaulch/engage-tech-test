...
const categoryModule = {
  state: () => ({
    categorys: [
      { id: 1, categoryId: 1, title: 'Cats', image: 'logo.svg' },
      { id: 2, categoryId: 1, title: 'Dogs', image: 'logo.svg' },
      { id: 3, categoryId: 1, title: 'Birds', image: 'logo.svg' },
      { id: 4, categoryId: 1, title: 'Rabbits', image: 'logo.svg' },
      { id: 5, categoryId: 1, title: 'Rodents', image: 'logo.svg' }
    ]
  }),
  mutations: {},
  actions: {},

...
const categoryModule = {
  state: () => ({
    categorys: [
      { id: 1, categoryId: "cats", title: "Cats", image: "icon-cat" },
      { id: 2, categoryId: "dogs", title: "Dogs", image: "icon-cat" },
      { id: 3, categoryId: "birds", title: "Birds", image: "icon-cat" },
      { id: 4, categoryId: "rabbits", title: "Rabbits", image: "icon-cat" },
    ...
    items: [
      {
        ...
        imageLarge: "https://placekitten.com/320/200?image=1",
      ...
      },
      {
        ...
        imageLarge: "https://placekitten.com/320/200?image=2",
      ...
      },
      {
        ...
        imageLarge: "https://placekitten.com/320/3200?image=3",
        ownerName: "Dave Baulch",
        ownerImage: "dave_250.png",
        ownerType: "Owner",
        ownerDate: "14th Jan 2020",

...
const categoryModule = {
  state: () => ({
    categorys: [
      { id: 1, categoryId: "cats", title: "Cats", image: "icon-cat.svg" },
      { id: 2, categoryId: "dogs", title: "Dogs", image: "icon-cat.svg" },
      { id: 3, categoryId: "birds", title: "Birds", image: "icon-cat.svg" },
      { id: 4, categoryId: "rabbits", title: "Rabbits", image: "icon-cat.svg" },
      { id: 5, categoryId: "rodents", title: "Rodents", image: "icon-cat.svg" },
    ],
  }),
  mutations: {},
  actions: {},

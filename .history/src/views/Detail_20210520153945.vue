  ...
  <div>
    ...
    <article class="m-6">
      <div class="flex">
        ...
        <div class="flex-1">
          <h2 class="flex">
            <p v-html="itemData.ownerName" />
          </h2>

          <span class="flex flex-row justify-between class="text-gray-500"">
            <p v-html="itemData.ownerType" class="text-gray-500" />
            <p v-html="itemData.ownerDate" class="text-gray-500" />
          </span>
        </div>
      </div>

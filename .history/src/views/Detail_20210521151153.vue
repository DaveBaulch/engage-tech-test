<template>
  <main role="main">
    <BaseButton
      ...
      v-animate:stagger.hideLeft.appearShortDelay
    >
    ...
    <BaseButton
      ...
      type="router-link"
      text="Enquire"
      class="absolute top-4 right-4 bg-red-400 text-white flex"
      v-animate:stagger.hideRight.appearShortDelay
    >
      <span class="mr-2">Enquire</span>
      <img :src="chevronRight" alt="Back" width="8" class="mt-1" />
    </BaseButton>
    <img :src="itemData.image" :alt="itemData.name" class="w-screen" />
    ...
    <section
      class="
        ...
        shadow-xl
      "
      v-animate:stagger.hideUp.appearLongDelay
    >
      >
      <dl>
        <dt>
          <h1 class="text-4xl font-bold mt-2">{{ itemData.name }}</h1>
        </dt>

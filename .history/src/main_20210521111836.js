...
animations.appearShortDelayShort = { ...animations.appearShort, delay: 0.3 };
animations.appearShortDelayLong = { ...animations.appearShort, delay: 0.9 };
animations.appearDelayShort = { ...animations.appear, delay: 0.3 };
